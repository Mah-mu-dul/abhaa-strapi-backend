...
export interface ApiAudioAudio extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    corpus: Schema.Attribute.Relation<'manyToOne', 'api::corpus.corpus'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    file: Schema.Attribute.Media<'audios', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiCorpusCorpus extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    audioFormats: Schema.Attribute.String;
    audioLength: Schema.Attribute.String;
    audios: Schema.Attribute.Relation<'oneToMany', 'api::audio.audio'>;
    CorpusId: Schema.Attribute.UID;
    country: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dialect: Schema.Attribute.String;
    ...
    subtitles: Schema.Attribute.Relation<'oneToMany', 'api::subtitle.subtitle'>;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiGenreGenre extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    corpuses: Schema.Attribute.Relation<'manyToMany', 'api::corpus.corpus'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiSubtitleSubtitle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    word_glosses: Schema.Attribute.Relation<
      'oneToMany',
      'api::word-gloss.word-gloss'
    >;
  };
}
...
export interface ApiTfiBlogTfiBlog extends Struct.CollectionTypeSchema {
  ...
  info: {
    displayName: 'TFI blog';
    pluralName: 'tfi-blogs';
    singularName: 'tfi-blog';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiTheFutureTheFuture extends Struct.CollectionTypeSchema {
  collectionName: 'the_futures';
  info: {
    displayName: 'The Future';
    pluralName: 'the-futures';
    singularName: 'the-future';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiWordGlossWordGloss extends Struct.CollectionTypeSchema {
  collectionName: 'word_glosses';
  info: {
    displayName: 'WordGloss';
    pluralName: 'word-glosses';
    singularName: 'word-gloss';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    subtitle: Schema.Attribute.Relation<'manyToOne', 'api::subtitle.subtitle'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
